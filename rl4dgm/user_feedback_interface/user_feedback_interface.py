...
class FeedbackInterface:
    def __init__(
        ...
        feedback_img_save_dir="real_human_ui_images",
        **kwargs,
    ):
        """
        Args:
        ...
        # create directory to save images shown to human evaluators
        self.feedback_img_save_dir = feedback_img_save_dir
        os.makedirs(feedback_img_save_dir, exist_ok=True)
...
class HumanFeedbackInterface(FeedbackInterface):
    ...
    def _query_batch_n_pick_m(self, prompts, image_batch, query_indices, **kwargs):
        ...
        self._save_query_image(
            ...
            img_save_path=f"{self.feedback_img_save_dir}/{self.run_name}_query_image.png",
    ...
    def _query_batch_n_pick_m_with_best(self, prompts, image_batch, query_indices, **kwargs):
        ...
        if self.is_first_batch:
            ...
            self._save_query_image(
                ...
                img_save_path=f"{self.feedback_img_save_dir}/{self.run_name}_best_image.png",
        ...
        if not self.is_first_batch:
            ...
            self._save_query_image(
                ...
                prompt="Choose the best image",
                img_save_path=f"{self.feedback_img_save_dir}/{self.run_name}_best_image_candidates.png",
    ...
    def _query_batch_score_one(self, prompts, image_batch, query_indices, **kwargs):
        ...
        for query, prompt in zip(query_indices, prompts):
            ...
            self._save_query_image(
                ...
                img_save_path=f"{self.feedback_img_save_dir}/{self.run_name}_reference_image.png",
            )
            pil_images += images
